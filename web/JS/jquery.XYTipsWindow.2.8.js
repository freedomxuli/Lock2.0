	...
	$.extend($.XYTipsWindow,{
		...
		showBox: function(o) {
			...
			var $boxDom = "<div id=\""+o.___boxID+"\" class=\"XYTipsWindow\">";
				...
				$boxDom += "<div class=\"___boxContent\" style=\" overflow-x: hidden;   overflow-y: hidden;  \"></div>";
				$boxDom += "<div class=\"___boxDialog\"></div>";
				$boxDom += "</div>";
				$boxDom += "<div class=\"___boxBd\"></div>";
				$boxDom += "<iframe src=\"about:blank\" scrolling=\"no\" style=\"position:absolute;left:0;top:0;filter:alpha(opacity=0);opacity:0;z-index:10714\"></iframe>";
				$boxDom += "</div>";
